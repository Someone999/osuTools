...
namespace osuTools.Beatmaps
{
    ...
    public class MD5String
    {
        ...
        private void ConvertToString()
        {
            if (string.IsNullOrEmpty(md5str))
            {
                if (CurrentMD5 is null || CurrentMD5.Hash is null)
                {
                    md5str = "";
                    return;
                }
        ...
        public static bool operator ==(MD5String obja, string objb)
        {
            ...
            if (obja is null && !string.IsNullOrEmpty(objb)) return false;
            if (obja is null && string.IsNullOrEmpty(objb) || !(obja is null) && !string.IsNullOrEmpty(objb))
                return true;
            if (string.Compare(obja.ToString(), objb, true) != 0)
                return false;
            return true;
        }
