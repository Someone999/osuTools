...
namespace osuTools.ORTDP
{
    public partial class OrtdpWrapper
    {
        ...
        private string _perfectstr = "&& Perfect";
        private double _tmp;
        ...
        [Alias("c300g")]
        public int Count300g { get; private set; }
        ...
        public string CountGekiRateStr
        {
            get
            {
                if (Count300g + Count300 == 0) return "0%";
        ...
        public TimeSpan SongDuration
        {
            get
            {
                if (_bp == null) return new TimeSpan();
        ...
        private double CalcAcc()
        {
            ...
            LstAccuarcy = _lastAcc;
            if (acc == 0) _lastAcc = 0;
            if (acc == _lastAcc) return acc;
        ...
        private double CalcC300Rate()
        {
            ...
            if (currentC300Rate == _lastC300Rate) return currentC300Rate;
        ...
        private double CalcC300GRate()
        {
            ...
            if (currentC300GRate == _lastC300GRate) return currentC300GRate;
